...
(function() {
    ...
    unsafeWindow.open = function(url, target, features) {
        ...
        const vertragsdetailsHeader = document.querySelector('button.sldo-cl-c-button[title*="Email mit allen wichtigen Vertragsinformationen"]');
        const shouldBlockInterception = vertragsdetailsHeader !== null;
