...
(function() {
    ...
    function isRecent(storedObj) {
        ...
        let recent = (!storedObj || !storedObj.timestamp);
        console.log("Time is  " + (Date.now() - storedObj.timestamp));
        return (Date.now() - storedObj.timestamp) <= 15 * 1000; //n seconds
    }
