...
(function () {
    ...
    function Autofill() {
        ...
        let salt = "TeslaByAixundFox2023"; //change regularly
        let car = document.querySelector('#form-password > div:nth-child(1) > div > div').innerText;
        ...
        document.querySelector('#form-password > div:nth-child(1) > div > div').style.cursor = "copy";
