        ...
        async function run() {
            try {
                ...
                (function(){
                    ...
                    setFieldByIdResolvedValue(pageData, "Profilierung_Anlageziel_Chbx_Altersvorsorge", true);
                ...
                const tasks = [
                    ...
                    },
                    {
                        ...
                        url: `${apiBase}/haushalt/${encodeURIComponent(wibiid)}clusters?clusterType=AvLaufendeEinnahmenUndAusgaben&clusterId=9c635702-2ea2-4190-942a-2cea750c46e1`,
                        needle: //TODO needs to be monatlicheNettoeinnahmen - monatlicheAusgaben calculated localy
                    },
                    {
