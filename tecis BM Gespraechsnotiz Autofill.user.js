...
(function () {
    ...
    // ==========================================================================================
    // MODULE 1: OVERVIEW / LAUNCHER
    // Matches: https://bm.bp.vertrieb-plattform.de/bm/?wibiid=*
    // Logic: Adds "Autofill" button and injects ?autofill=true into the window.open flow
    // ==========================================================================================
    if (currentUrl.includes("/bm/?wibiid=")) {
        console.log("[BP Autofill] Launcher Module Active");
        ...
        // ==========================================================================================
        // MODULE 2: EDITOR / EXECUTOR
        // Matches: https://bm.bp.vertrieb-plattform.de/edocbox/editor/ui/?documentid=*
        // Logic: Checks ?autofill=true and fills fields via API
    // ==========================================================================================
    else if (currentUrl.includes("/edocbox/editor/ui/")) {
        console.log("[BP Autofill] Editor Module Active");
